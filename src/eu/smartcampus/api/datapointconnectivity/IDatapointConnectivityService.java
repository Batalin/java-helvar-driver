 ...
 */
/*
 * Note: Doc updates - Timestamps are local to datapoints. - Read and write operations are
 * not instantaneous.
 */
public interface IDatapointConnectivityService {

    /**
     * The unique name of this implementation used to identify it in a registry of
     * existing implementations of this API.
     * 
     * @return a string containing the name of this API implementation (ex. Polimi KNX
     *         Implementation)
     */
    ...
    interface DatapointListener {
         ...
         */
        void onDatapointUpdate(DatapointAddress address, DatapointValue[] values);
        ...
        /**
         * Invoked when new datapoints are detected in the network or cease to exist.
         *
         * @param address the address of the respective datapoint
         */
        void onDatapointAddressListChanged(DatapointAddress[] address);
    }

    /**
     * The type of error found in read or write operations. The detection of some of the
    ...
    enum ErrorType {
        ...
        DEVICE_BUSY,
        /**
         * The datapoint operation was aborted due to an internal error.
         */
        DEVICE_INTERNAL_ERROR,
        /**
         * The device URL is malformed.
         */
        DEVICE_INVALID_URL,
        /**
    ...
    interface ReadCallback {
         ...
         */
        void onReadAborted(DatapointAddress address, ErrorType reason, int requestId);
         ...
         */
        void onReadCompleted(DatapointAddress address, DatapointValue[] readings, int requestId);
    }
    ...
    interface WriteCallback {
         ...
         * @param requestId the id of the request
         */
        void onWriteAborted(DatapointAddress address, ErrorType reason, int requestId);
         ...
         * @param requestId the request id
         */
        void onWriteCompleted(DatapointAddress address, WritingConfirmationLevel confirmationLevel, int requestId);
    }
     ...
     */
    int requestDatapointRead(DatapointAddress address, ReadCallback readCallback) throws OperationFailedException;
     ...
     * @throws OperationFailedException
     */
    int requestDatapointWindowRead(DatapointAddress address, long startTimestamp, long finishTimestamp, ReadCallback readCallback) throws OperationFailedException;
     ...
     * @throws OperationFailedException
     */
    int requestDatapointWrite(DatapointAddress address, DatapointValue[] values, WriteCallback writeCallback) throws OperationFailedException;
