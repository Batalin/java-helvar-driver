...
public class WriteCallbackImpl
     ...
     * 
     * @see
     * eu.smartcampus.api.IDatapointConnectivityService.WriteCallback#onWriteAborted(eu
     * .smartcampus.api.DatapointAddress,
     * eu.smartcampus.api.IDatapointConnectivityService.ErrorType, int)
     */
     ...
     * 
     * @see
     * eu.smartcampus.api.IDatapointConnectivityService.WriteCallback#onWriteCompleted
     * (eu.smartcampus.api.DatapointAddress,
     * eu.smartcampus.api.IDatapointConnectivityService.WritingConfirmationLevel, int)
     */
    public void onWriteCompleted(DatapointAddress address, WritingConfirmationLevel confirmationLevel, int requestId) {
        isWritten = true;
        semaphore.release();
