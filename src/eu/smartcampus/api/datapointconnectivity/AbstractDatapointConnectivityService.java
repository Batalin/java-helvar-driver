...
public abstract class AbstractDatapointConnectivityService implements
	...
	@Override
	public abstract DatapointMetadata getDatapointMetadata(
			DatapointAddress address) throws OperationFailedException;
	...
	public abstract int requestDatapointRead(DatapointAddress address,
			ReadCallback readCallback) throws OperationFailedException;
